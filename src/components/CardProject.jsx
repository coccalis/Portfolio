...
function CardProject({ image, title, description, gh, tech }) {
  return (
    <div className="rounded-md m-5 border-1 border-bg-primary dark:border-bg-light">
      ...
      <div className="p-2">
        ...
        <div className="flex space-x-5 mt-2">
          {tech.map((item, index) => (
            <div
              key={index}
              className="flex items-center p-2 border-1 rounded-md border-bg-primary dark:border-bg-light cursor-pointer hover:bg-gray-200 hover:dark:bg-violet-50/40 transition"
            >
